...
/**
  * @ObjectName GenerateRandomText
  * @Description TODO
  * @Author kngin
  * @Date: 2019/2/24 12:00
  * @Version 1.0
  **/

/**
  * nextGaussian()，生成的数值符合均值为0方差为1的高斯/正态分布，即符合标准正态分布
  */

object GenerateRandomText {

  def main(args: Array[String]): Unit = {
    val outputPath = new File("E:\\SparkDev\\datas\\generaterandomtext\\randomText-10MB.txt")
    ...
    while (outputPath.length() < 10 * 1024 * 1024) {
      ...
      writer.write(words.apply(index.toInt))  // 根据随机生成下标取words数组中的单词
      writer.write(" ")
